...
export function createScene(container) {
  ...
  const camera = new THREE.PerspectiveCamera(isMobile ? 65 : 55, container.clientWidth / container.clientHeight, 1, 20000)
  camera.position.set(0, isMobile ? 140 : 110, isMobile ? 350 : 300)
  camera.lookAt(0, isMobile ? 10 : 25, isMobile ? -30 : 0)
